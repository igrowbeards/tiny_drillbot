...
class PlayState_obj : public ::org::flixel::FlxState_obj{
	...
	public:
		...
		virtual Void hitSpikes( ::org::flixel::FlxObject Player,::org::flixel::FlxObject spikes);
		Dynamic hitSpikes_dyn();

		virtual Void changeLevel( ::org::flixel::FlxObject Player,::org::flixel::FlxObject Exit);
