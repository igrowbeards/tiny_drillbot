...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/exit.png", NME_assets_exit_png);
			resourceTypes.set ("assets/exit.png", "image");
			...
			resourceClasses.set ("assets/goomba.png", NME_assets_goomba_png);
			resourceTypes.set ("assets/goomba.png", "image");
			resourceClasses.set ("assets/goomba_tiles.png", NME_assets_goomba_tiles_png);
			...
			resourceClasses.set ("assets/mapCSV_Group1_fuel.csv", NME_assets_mapcsv_group1_fuel_csv);
			resourceTypes.set ("assets/mapCSV_Group1_fuel.csv", "text");
			resourceClasses.set ("assets/mapCSV_Group1_level1_enemies.csv", NME_assets_mapcsv_group1_level1_enemies_csv);
			resourceTypes.set ("assets/mapCSV_Group1_level1_enemies.csv", "text");
			resourceClasses.set ("assets/mapCSV_Group1_map.csv", NME_assets_mapcsv_group1_map_csv);
			resourceTypes.set ("assets/mapCSV_Group1_map.csv", "text");
			...
			resourceClasses.set ("assets/mapCSV_Group1_spikes.csv", NME_assets_mapcsv_group1_spikes_csv);
			resourceTypes.set ("assets/mapCSV_Group1_spikes.csv", "text");
			...
			resourceClasses.set ("assets/mapCSV_level2_enemies.csv", NME_assets_mapcsv_level2_enemies_csv);
			resourceTypes.set ("assets/mapCSV_level2_enemies.csv", "text");
			resourceClasses.set ("assets/mapCSV_level2_fuel.csv", NME_assets_mapcsv_level2_fuel_csv);
			resourceTypes.set ("assets/mapCSV_level2_fuel.csv", "text");
			resourceClasses.set ("assets/mapCSV_level2_lava.csv", NME_assets_mapcsv_level2_lava_csv);
			resourceTypes.set ("assets/mapCSV_level2_lava.csv", "text");
			resourceClasses.set ("assets/mapCSV_level2_map.csv", NME_assets_mapcsv_level2_map_csv);
			resourceTypes.set ("assets/mapCSV_level2_map.csv", "text");
			resourceClasses.set ("assets/mapCSV_level2_Map2.csv", NME_assets_mapcsv_level2_map2_csv);
			resourceTypes.set ("assets/mapCSV_level2_Map2.csv", "text");
			resourceClasses.set ("assets/mapCSV_Level_1_fuel.csv", NME_assets_mapcsv_level_1_fuel_csv);
			resourceTypes.set ("assets/mapCSV_Level_1_fuel.csv", "text");
			resourceClasses.set ("assets/mapCSV_Level_1_level1_enemies.csv", NME_assets_mapcsv_level_1_level1_enemies_csv);
			resourceTypes.set ("assets/mapCSV_Level_1_level1_enemies.csv", "text");
			resourceClasses.set ("assets/mapCSV_Level_1_map.csv", NME_assets_mapcsv_level_1_map_csv);
			resourceTypes.set ("assets/mapCSV_Level_1_map.csv", "text");
			resourceClasses.set ("assets/mapCSV_Level_1_spikes.csv", NME_assets_mapcsv_level_1_spikes_csv);
			resourceTypes.set ("assets/mapCSV_Level_1_spikes.csv", "text");
			resourceClasses.set ("assets/new-level1.dam", NME_assets_new_level1_dam);
			resourceTypes.set ("assets/new-level1.dam", "text");
			resourceClasses.set ("assets/new-level1.dam.bak", NME_assets_new_level1_dam_bak);
			resourceTypes.set ("assets/new-level1.dam.bak", "text");
