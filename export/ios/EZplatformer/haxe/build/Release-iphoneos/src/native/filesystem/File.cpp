...
::String File_obj::set_url( ::String inPath){
	...
	if (((inPath == null()))){
		...
		HX_STACK_LINE(73)
		if ((::StringTools_obj::startsWith(inPath,::native::filesystem::File_obj::nme_get_resource_path()))){
			HX_STACK_LINE(73)
...
void File_obj::__boot()
{
	...
	DOCS= (int)3;
	USER= (int)4;
	nme_get_resource_path= ::native::Loader_obj::load(HX_CSTRING("nme_get_resource_path"),(int)0);
