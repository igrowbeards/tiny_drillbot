...
::org::flixel::plugin::photonstorm::FlxControlHandler_obj::__register();
::org::flixel::plugin::photonstorm::FlxControl_obj::__register();
...
::org::flixel::FlxParticle_obj::__register();
...
::addons::FlxBackdrop_obj::__register();
::Xml_obj::__register();
...
::Hash_obj::__register();
::Goombas_obj::__register();
::org::flixel::FlxGroup_obj::__register();
::Goomba_obj::__register();
::Fuel_obj::__register();
::Elevator_obj::__register();
...
::org::flixel::FlxParticle_obj::__boot();
...
::org::flixel::plugin::photonstorm::FlxControl_obj::__boot();
::org::flixel::plugin::photonstorm::FlxControlHandler_obj::__boot();
